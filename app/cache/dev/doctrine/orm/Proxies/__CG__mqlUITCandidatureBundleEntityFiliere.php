 ...
 */
class Filiere extends \mqlUIT\CandidatureBundle\Entity\Filiere implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'grade', 'intitule', 'responsable');
    }
