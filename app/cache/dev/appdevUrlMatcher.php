...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/filiere')) {
            ...
            // filiere_new
            if (0 === strpos($pathinfo, '/filiere/new') && preg_match('#^/filiere/new/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'filiere_new')), array (  '_controller' => 'mqlUIT\\CandidatureBundle\\Controller\\FiliereController::newAction',));
            }
        ...
        if (0 === strpos($pathinfo, '/experience')) {
            ...
            // experience_supprimer
            if (preg_match('#^/experience/(?P<id>[^/]++)/supprimer$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'experience_supprimer')), array (  '_controller' => 'mqlUIT\\CandidatureBundle\\Controller\\ExperienceController::supprimerAction',));
            }
        ...
        if (0 === strpos($pathinfo, '/diplome')) {
            ...
            // diplome_supprimer
            if (preg_match('#^/diplome/(?P<id>[^/]++)/supprimer$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'diplome_supprimer')), array (  '_controller' => 'mqlUIT\\CandidatureBundle\\Controller\\DiplomeController::supprimerAction',));
            }
        ...
        if (0 === strpos($pathinfo, '/candidature')) {
            ...
            if (0 === strpos($pathinfo, '/candidature/validation')) {
                // candidature_validation
                if ($pathinfo === '/candidature/validation') {
                    return array (  '_controller' => 'mqlUIT\\CandidatureBundle\\Controller\\CandidatureController::validationAction',  '_route' => 'candidature_validation',);
                }

                // candidature_validationshow
                if ($pathinfo === '/candidature/validationshow') {
                    return array (  '_controller' => 'mqlUIT\\CandidatureBundle\\Controller\\CandidatureController::validationshowAction',  '_route' => 'candidature_validationshow',);
                }
        ...
        if (0 === strpos($pathinfo, '/detailsemestre')) {
            ...
            // detailsemestre_supprimer
            if (preg_match('#^/detailsemestre/(?P<id>[^/]++)/supprimer$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'detailsemestre_supprimer')), array (  '_controller' => 'mqlUIT\\CandidatureBundle\\Controller\\DetailSemestreController::supprimerAction',));
            }
        ...
        // fos_user_registration_register_Admin
        if ($pathinfo === '/ajoutResponsable') {
            return array (  '_controller' => 'mqlUIT\\UserBundle\\Controller\\RegistrationController::registerAdminAction',  '_route' => 'fos_user_registration_register_Admin',);
        }
